                ...
                <div id="nav_div">                   
                    <ul>
                        ...
                        while($row=$db->fetch_object($rez))
                            echo "<li><a href='mainpage.php?category={$row->type}'>{$row->type}</a></li>";
                        //Provera da li je neko ulogovan
                        if(login())
                            echo "<li style='float: right;'><a class='navigation-active' href='logoutpage.php'>{$_SESSION['info']} ({$_SESSION['status']})</a></li>";
                        else
                            echo "<li style='float: right; width: 300px'><a class='navigation-active' href='loginpage.php'>Log in</a></li>";
                       ?>
